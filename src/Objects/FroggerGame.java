...
public class FroggerGame {
	...
	public FroggerGame() {
		...
		/*
		 * todo Sets the lifeTimer todo Creates all the lanes
		 */
	...
	void lilyCheck() {
		/*
		 * todo lilyCheck Processes the games response when the player is in the
		 * lane with the lily pads. If the player is on the last lily pad he/she
		 * will win. When the players is on a lily pad that is not the last one
		 * it will be set to store a frog and teleport the player back to the
		 * start. When the player is not on an empty lily pad he/she will be
		 * pushed back into the log lane.
		 */
	}
